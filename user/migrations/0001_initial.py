# Generated by Django 4.1.3 on 2023-06-05 09:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "sub_image1",
                    versatileimagefield.fields.VersatileImageField(blank=True, null=True, upload_to="products/"),
                ),
                (
                    "sub_image2",
                    versatileimagefield.fields.VersatileImageField(blank=True, null=True, upload_to="products/"),
                ...
                (
                    "category",
                    models.ForeignKey(
                        blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to="user.category"
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "user",
                    models.ForeignKey(
                        default="", null=True, on_delete=django.db.models.deletion.CASCADE, to="user.customer"
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "subbanner2",
                    versatileimagefield.fields.VersatileImageField(blank=True, null=True, upload_to="SubBanners/"),
                ),
                (
                    "category",
                    models.ForeignKey(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to="user.subcategory"
            ),
        ),
        migrations.CreateModel(
            name="MainBanner",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "offer_product",
                    models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to="user.product"),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "user",
                    models.ForeignKey(
                        blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to="user.customer"
                    ),
                ),
            ],
        ),
